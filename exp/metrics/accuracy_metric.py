...
class AccuracyMetric(Metric):
    ...
    def valueI(self):
        ...
        mIoUI, instanceIoU = self.reduceI(IoUIC, return_instance_value=True)
        mDiceI, instanceDice = self.reduceI(DiceIC, return_instance_value=True)
        ...
        return {"mAccI": mAccI,
                ...
                "instanceIoU": instanceIoU,
                "instanceDice": instanceDice,}
    ...
    def valueC(self):
        ...
        mIoUC, classIoU = self.reduceC(IoUIC, return_class_value=True)
        mDiceC, classDice = self.reduceC(DiceIC, return_class_value=True)
    ...
    def reduceI(self, value_matrix, q=None, return_instance_value=False):
        ...
        sorted_value = torch.sort(value)[0][:n]
        mean_value = 100 * torch.mean(sorted_value)
        if return_instance_value:
            return mean_value, value
        return mean_value


    def reduceC(self, value_matrix, q=None, return_class_value=False):
        ...
        mean_value = 100 * torch.mean(value)

        if return_class_value:
            return mean_value, value
        return mean_value
