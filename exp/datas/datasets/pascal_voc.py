...
class PASCALVOC(BaseDataset):
    ...
    def get_image_list(self):
        trainaug_txt = f"{self.data_dir}/VOCdevkit/VOC2012/ImageSets/Segmentation/train_aug.txt"
        ...
        train_image_list = [f"{self.data_dir}/VOCdevkit/VOC2012{idx.split()[0]}" for idx in trainaug_idx]
